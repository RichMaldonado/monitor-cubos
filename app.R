...
server <- function(input, output, session) {
  ...
  # --- B. Lógica de Carga de Datos CRUDOS ---
  ...
  mod_sectores_server("sectores", datos = datos_sectores_procesados, lista_gvs = list_gv_raw_reactivos) # , lista_gvs = list_gv_raw_reactivos
